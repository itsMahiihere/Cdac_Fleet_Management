...
public class CarMasterController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CarMaster> getCarById(@PathVariable("id") Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CarMaster> updateCar(@PathVariable("id") Long id, @RequestBody CarMaster car) {
    ...
    public ResponseEntity<List<CarMaster>> getCarsByCarType(@PathVariable("cartypeId") Long cartypeId) {
