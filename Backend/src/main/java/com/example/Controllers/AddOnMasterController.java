...
public class AddOnMasterController {
    ...
    @GetMapping("/{addonId}")
    public ResponseEntity<AddOnMaster> getAddOnById(@PathVariable("addonId") Long addonId) {
    ...
    public ResponseEntity<String> deleteAddOnById(@PathVariable("addonId") Long addonId) {
